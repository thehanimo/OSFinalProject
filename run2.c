...
int main (int argc,char *argv[]) {
   ...
   printf("XOR: %u Block Count: %u File size: %u Read speed: %f MiB/s\n", out_xor, out_block_count, out_block_count * block_size, (float) out_block_count * block_size / (read_time * 1000000));
